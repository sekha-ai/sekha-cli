...
class TestConfigLoading:
    ...
    def test_load_config(self, temp_config_dir):
        ...
        config_file = temp_config_dir / "config.yaml"  # Change .toml to .yaml
    ...
    """.lstrip())  # Remove leading newline
        ...
        assert config.api_key == "sk-test-valid-key-1234567890"
    ...
    def test_create_default_config(self, temp_config_dir):
        ...
        assert loaded.base_url is not None
...
class TestConfigSaving:
    ...
    def test_save_config(self, temp_config_dir):
        ...
        config = Config(base_url="http://example.com", api_key="new-key-123")
...
class TestConfigValidation:
    ...
    def test_valid_url(self):
        ...
        config = Config(base_url="http://localhost:8080", api_key="key")
